...
class DateTimeTest extends TestCase
{
    ...
    public function testAdd(
        ...
        $datetime = new DateTime($datetime, new BaseDateTimeZone($timezone));
    ...
    public function testDiffIntervalVsDuration(): void
    {
        ...
        $datetimeA  = new DateTime('2025-03-30 00:00:00', $timezone);
        $datetimeB  = new DateTime('2025-03-30 05:00:00', $timezone);
    ...
    {
        $timezone   = new BaseDateTimeZone('Europe/Berlin');
        $datetimeA  = new DateTime('2025-03-30 01:00:00', $timezone);
        $datetimeB  = new DateTime('2025-03-30 04:00:00', $timezone);
    ...
    {
        $datetimeA  = new DateTime('2025-03-01 00:00:00', new BaseDateTimeZone('Europe/Berlin'));
        $datetimeB  = new DateTime('2025-05-01 00:00:00', new BaseDateTimeZone('Europe/Amsterdam'));
